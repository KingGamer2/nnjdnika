...
client.on('ready', function(){    
    ...
    var setGame = [`المستخدمين : ${client.users.size}`,`${prefix}help | For Help`];    // لا تلعب بشيء
    var i = -1;    
    var j = 0;    
...
client.on('message', msg => {
  if (msg.content === prefix + "ownerbot") {
    msg.reply('**OwnerBot <@484106911696945153>**');
  }
});
...
client.on('message', msg => {
  if (msg.content === prefix + "help-list") {
    msg.reply(':envelope: | تم ارسال الرساله في الخاص');
  }
});
...
client.on("message", message => {
 if (message.content === prefix + "support") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('© MineCraft Center جميع الحقوق محفوظة 2018 لــبوت')
...
if (message.content.startsWith(prefix + "bcall")){
 if (message.author.id !== '484106911696945153') return message.reply('** هذا الأمر قفط لصاحب البوت و شكراًً **')
...
『!support/سيرفر الدعم』
『!allbots /رؤية جميع بوتات السيرفر』
...
『!server/يجبلك معلومات عن السيرفر』
『!update/حتى تشوف اخر تحديثات للبوت』
『!roles/لمعرفة الرتب الي في السيرفر』
『!avatar/صورتك او صورة الي تمنشنو』
『!short/يختصر لك رابط كبير الى رابط صغير』
『!trans <language> <world>/يترجم لك الي تبيه من اي لغة』
『!channelinfo/ليعطيك معلومات الغرفة』
『!id/لمعرفة معلوماتك بلكامل』
『!roomsall/يعرض لك كل الرومات الي بالسيرفر مع عددها』
『!new/حتى تسوي تكت』
『!emojilist/يعرض لك كل الايموجيات الي بالسيرفر』
『!image/صورة السيرفر』
『!cal/لاستخدام الالة الحاسبة + للجمع - للطرح * للضرب / للقسمة』
『!tv/انشاء روم مؤقت ويمكنك تحديد الاعدادات』
『!owner/لارسال رسالة لاونر سيرفر』
『!uptime/عشان تشوف البوت شغال من متى』
『!emoji <any things>/لتحويل اي كلمه تقولها الي ايموجي』
『!ping/يقلك كم بنق البوت』
『!suggest/لاقتراح شئ و لازم يكون فيه روم اسمه suggestions』
『!report/عشان تبلغ عن شخص』
**
  `
,`
        ***__أوامر الأدمن__***
**
『!autorole toggle  /عشان تفعل الautorole <خلي رتبة البوت  فوق الرتبة لبتحددها>』
『!autorole set  /عشان تحط الرتبة الي اول ما احد يدخل ياخذها』
『!ms / رسالة جماعية الى كل اعضاء السيرفر』
...
『!mute @user  / اعطاء العضو ميوت لازم رتبة <Muted>』
『!unmute @user / لفك الميوت عن الشخص 』
『!kick @user / طرد الشخص من السيرفر』
『!ban @user  /عشان تعطي احد حظر من سيرفر』
『!unban @user  /عشان تفك حظر عن شخص』
『!tempban @user  /عشان تعطي احد حظر من السيرفر بمدة』
『!tempmute @user  /لاعطاء احد ميوت يعني تجعله ما يقدر يرسل ولا شئ لمدة محددة』
『!mutechannel / عشان تخلي ما فيه احد يقدر يكتب في الروم المحدد』
『!unmutechannel / عشان ترجع الناس تقدر تكتب في الروم الي كتمته』
『!dc / مسح كل الرومات』
『!dr / <مسح كل الرانكات <لازم تكون رانك البوت فوق كل الرانكات』
『!delete <name> / مسح الشات او الرووم فويس』
『!role  / يعرض لك قائمة اوامر الرول بطريقة اسطورية』
『say/يكرر الكلام الي تكتبو و يحذف كلامك』
『!bans /عشان تشوف عدد المبندين في السيرفر 』
『!warn / عشان تعطي احد انذار و لكي يشتغل الامر سوي روم اسمه warns』
**
   `,`
        ***__أوامر الموسيفة__***
**
...
client.on("message", message => {
 if (message.content === prefix + "help-list") {
  const embed = new Discord.RichEmbed() 
      .setColor("#ffff00")
      .setThumbnail(message.author.avatarURL)
      .setDescription(`

👑Commands MineCraft Center|أوامر البوت الأسطورية👑

● ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ● 
💎『MineCraft Center』💎                     
💎 !help 『لعرض قائمة اوامر الادارة و العامة و الالوان و الميوزك و الالعاب』
